...
impl SatisfiableItem {
    ...
    /// # Note
    ///
    /// In version X.Y.Z The id calculation for [`SatisfiableItem::Thresh`] nodes was changed to
    /// fix id instability due to runtime variability. Any previously persisted
    /// [`SatisfiableItem::Thresh`] node ids should be recomputed from the descriptor.
